...
- **⚠️ รอเจ้าของตัดสิน: โรงแรมเดียวกันลง 2 slug 8 คู่ (16 หน้า)** — เช่น `review-bundhaya-resort-koh-lipe` vs `…-satun` · เกิดจากจัดคนละ cluster (เมืองท่องเที่ยว vs จังหวัด) · **ยังไม่แตะอะไร** เพราะทั้งคู่มีลิงก์เข้าจริง + อยู่ใน sitemap (ลบ = ลิงก์เสียกลับมา) และ 3 คู่ตัวเลขลิงก์ขัดกับกติกา "เมืองท่องเที่ยว" — ตารางเต็ม + ทางเลือก (301 vs canonical) อยู่ใน `_internal/SESSION-END-2026-07-18.md`
