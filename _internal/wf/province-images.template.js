...
- ⚠️ ความปลอดภัยไฟล์ (บังคับ): curl -o **ตรงไปยัง path ปลายทางเท่านั้น** · ห้ามสร้างไฟล์ test/temp/_tmp_ · **ห้ามใช้ `rm` หรือลบไฟล์ใด ๆ เด็ดขาด** โดยเฉพาะ wildcard (เช่น `rm c*.jpg`) — โฟลเดอร์ images มีรูปจังหวัดอื่นปนอยู่ ลบพลาดทำหน้าอื่นพัง · โหลดผิดให้ curl ทับชื่อเดิม
`
