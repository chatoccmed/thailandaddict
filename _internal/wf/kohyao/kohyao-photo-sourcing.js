export const meta = {
  name: 'kohyao-photo-sourcing',
  description: 'Find 4 directly-downloadable real photos per Koh Yao hotel from official sites / Trip.com',
  phases: [{ title: 'Sources' }],
}
const RESEARCH = 'C:\\Users\\Imac\\Thailandaddict\\thailandaddict\\_internal\\wf\\kohyao\\research.json'
const SCHEMA = {
...
const results = await parallel(SLUGS.map(slug => () =>
  agent(
    `Find up to 4 directly-downloadable REAL photos of a specific Koh Yao hotel, for a Thai travel-site review.
