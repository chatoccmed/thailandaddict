export const meta = {
  name: 'port-ubon-ratchathani',
  description: 'Single-planner porter for อุบลราชธานี (cluster=ubon-ratchathani): one agent plans all 2 roundup(s) together -> unique hotels -> reviews >=2000w -> roundups. Reuses existing ubon-ratchathani reviews.',
  phases: [
...
const CLUSTER = "ubon-ratchathani", PROV = "อุบลราชธานี", CRUMB = "อุบลราชธานี", CRUMBHREF = "city-ubon-ratchathani.html";
const POSTS = [{"old":"top10-ubon-ratchathani-hotels-2","newSlug":"top10-ubon-ratchathani-city-hotels","title":"10 โรงแรมบรรยากาศดีในเมืองอุบลราชธานี","n":10},{"old":"top10-ubon-ratchathani-hotels","newSlug":"top10-ubon-ratchathani-budget-hotels","title":"10 ที่พักหลักร้อยในเมืองอุบลราชธานี","n":10}];
...
const PLAN_SCHEMA = {"type":"object","additionalProperties":false,"required":["hotels","roundups"],"properties":{"hotels":{"type":"array","description":"โรงแรม unique ทั้งหมด (1 slug ต่อ 1 โรงแรมจริง ใช้ซ้ำข้าม roundup ได้)","items":{"type":"object","additionalProperties":false,"required":["name","reviewSlug","area","tier","star","open"],"properties":{"name":{"type":"string"},"reviewSlug":{"type":"string","description":"review-<hotel-kebab-en>-ubon-ratchathani"},"area":{"type":"string"},"tier":{"type":"string"},"star":{"type":"number"},"open":{"type":"boolean"},"note":{"type":"string"}}}},"roundups":{"type":"array","description":"membership ต่อ roundup","items":{"type":"object","additionalProperties":false,"required":["newSlug","reviewSlugs"],"properties":{"newSlug":{"type":"string"},"reviewSlugs":{"type":"array","items":{"type":"string"},"description":"reviewSlug เรียงตามอันดับ"}}}}}};
