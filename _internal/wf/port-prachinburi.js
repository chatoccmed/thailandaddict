export const meta = {
  name: 'port-prachinburi',
  description: 'Single-planner porter for ปราจีนบุรี (cluster=prachinburi): one agent plans all 3 roundup(s) together -> unique hotels -> reviews >=2000w -> roundups. Reuses existing prachinburi reviews.',
  phases: [
...
const CLUSTER = "prachinburi", PROV = "ปราจีนบุรี", CRUMB = "ปราจีนบุรี", CRUMBHREF = "city-prachinburi.html";
const POSTS = [{"old":"top-6-hotels-304-industrial-park-srimahapho-prachin-buri","newSlug":"top6-304-industrial-hotels-prachinburi","title":"6 ที่พักใกล้นิคม 304 ศรีมหาโพธิ ปราจีนบุรี","n":6},{"old":"top5-kabin-buri-prachin-buri-hotels","newSlug":"top5-kabin-buri-hotels-prachinburi","title":"5 ที่พักกบินทร์บุรี ปราจีนบุรี","n":5},{"old":"top10-prachin-buri-hotels","newSlug":"top10-prachinburi-city-hotels","title":"10 โรงแรมราคาสบายในเมืองปราจีนบุรี","n":10}];
...
const PLAN_SCHEMA = {"type":"object","additionalProperties":false,"required":["hotels","roundups"],"properties":{"hotels":{"type":"array","description":"โรงแรม unique ทั้งหมด (1 slug ต่อ 1 โรงแรมจริง ใช้ซ้ำข้าม roundup ได้)","items":{"type":"object","additionalProperties":false,"required":["name","reviewSlug","area","tier","star","open"],"properties":{"name":{"type":"string"},"reviewSlug":{"type":"string","description":"review-<hotel-kebab-en>-prachinburi"},"area":{"type":"string"},"tier":{"type":"string"},"star":{"type":"number"},"open":{"type":"boolean"},"note":{"type":"string"}}}},"roundups":{"type":"array","description":"membership ต่อ roundup","items":{"type":"object","additionalProperties":false,"required":["newSlug","reviewSlugs"],"properties":{"newSlug":{"type":"string"},"reviewSlugs":{"type":"array","items":{"type":"string"},"description":"reviewSlug เรียงตามอันดับ"}}}}}};
