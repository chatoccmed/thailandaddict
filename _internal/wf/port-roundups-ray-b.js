...
// === Rayong-B (cluster=rayong): wang-kaew, mae-phim, Koh Samet x2 ===
const PROV = 'ระยอง', CLUSTER = 'rayong', CRUMB = 'ระยอง', CRUMBHREF = 'city-rayong.html';
const POSTS = [
  { id:3584, old:'4top-rayoung-wang-keaw', newSlug:'top4-wang-kaew-beach-hotels-rayong', title:'4 ที่พักริมหาดวังแก้ว ระยอง', n:4 },
  { id:2993, old:'top-5-mae-phim-beach-rayogg', newSlug:'top5-mae-phim-beach-hotels-rayong', title:'5 โรงแรมริมหาดแม่พิมพ์ ระยอง', n:5 },
  { id:1499, old:'top10-cheap-samet-samed-rayong-hotels', newSlug:'top10-budget-hotels-koh-samet', title:'10 ที่พักหลักร้อยบนเกาะเสม็ด ระยอง', n:10 },
  { id:864, old:'top10-samet-island-hotel', newSlug:'top10-beach-hotels-koh-samet', title:'10 โรงแรมริมหาดบรรยากาศดี เกาะเสม็ด ระยอง', n:10 },
];
...
สำคัญ: โรงแรมเดียวกันต้องได้ reviewSlug **เดียวกันเป๊ะ** ทุกที่ที่อ้างถึง`,
  { label:'plan:ray-b', phase:'Plan', schema:PLAN_SCHEMA })
