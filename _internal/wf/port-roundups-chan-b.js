...
// === Chanthaburi-B (cluster=chanthaburi): city/boutique/hostel/mountain ===
const PROV = 'จันทบุรี', CLUSTER = 'chanthaburi', CRUMB = 'จันทบุรี', CRUMBHREF = 'city-chanthaburi.html';
const POSTS = [
  { id:501, old:'top10-chanthaburi-thailand-hotels', newSlug:'top10-chanthaburi-city-hotels', title:'10 ที่พักยอดนิยมในเมืองจันทบุรี', n:10 },
  { id:3049, old:'top5-chanthaburi-hotels', newSlug:'top5-boutique-hotels-chanthaburi', title:'5 ที่พักบูติก-สกีรีสอร์ตเก๋ ในจันทบุรี', n:5 },
  { id:3273, old:'top5-hostel-chantaburee', newSlug:'top5-hostels-chanthaburi', title:'5 Hostel น่าพักในจันทบุรี', n:5 },
  { id:3008, old:'top9-hostels-chanthaburi', newSlug:'top5-soi-dao-mountain-view-hotels-chanthaburi', title:'5 ที่พักชมวิวสอยดาว ใกล้เขาคิชฌกูฏ จันทบุรี', n:5 },
];
...
สำคัญ: โรงแรมเดียวกันต้องได้ reviewSlug **เดียวกันเป๊ะ** ทุกที่ที่อ้างถึง`,
  { label:'plan:chan-b', phase:'Plan', schema:PLAN_SCHEMA })
