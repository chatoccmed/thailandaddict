export const meta = {
  name: 'satun-articles',
  description: 'Satun (สตูล) gold template — food / attractions / itineraries / prep (37 articles, v2-clean Thai, articleSchema JSON)',
  phases: [
    { title: 'Food', detail: '11 food articles incl. ranked-by-cuisine' },
    { title: 'See', detail: '12 attraction articles (islands + geopark + culture)' },
...
const FOOD = [
  ['satun-seafood','eat-ranking','ร้านอาหารทะเลอันดามันสตูล ปากบารา-ในเมือง กุ้ง หอย ปู ปลาสด'],
  ['satun-southern-food','eat-ranking','อาหารใต้รสจัดสตูล แกงไตปลา คั่วกลิ้ง ผัดสะตอ ร้านที่คนพื้นที่ไป'],
  ['satun-roti-cha-chak','eat-ranking','โรตีและชาชักร้านมุสลิมสตูล เปิดเช้าถึงดึก ร้านเด็ด'],
  ['satun-muslim-malay-food','eat-ranking','อาหารมุสลิม-มลายูสตูล นาซิดาแฆ ข้าวหมกไก่ ไก่กอและ'],
  ['satun-khao-yam','food','ข้าวยำปักษ์ใต้สตูล น้ำบูดู ผักหั่นฝอย มื้อเช้าเบา'],
  ['satun-khanom-jeen','eat-ranking','ขนมจีนน้ำยาปักษ์ใต้สตูล ผักเหนาะสารพัด ร้านเช้า'],
  ['satun-cafe-guide','eat-ranking','คาเฟ่สตูล ในเมืองและบนเกาะหลีเป๊ะ กาแฟสด บรรยากาศ'],
  ['lipe-food-walking-street','food','ของกินถนนคนเดินเกาะหลีเป๊ะ ซีฟู้ดปิ้งย่าง ของกินเล่นยามเย็น'],
