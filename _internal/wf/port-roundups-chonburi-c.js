...
// === Chonburi-C chunk (cluster=chonburi): Sattahip, U-Tapao, Burapha ===
const PROV = 'ชลบุรี', CLUSTER = 'chonburi', CRUMB = 'ชลบุรี', CRUMBHREF = 'city-chonburi.html';
const POSTS = [
  { id:3029, old:'top-10-sattahip-pattaya', newSlug:'top10-sattahip-hotels-chonburi', title:'10 ที่พักในสัตหีบ ชลบุรี', n:10 },
  { id:3588, old:'top-5-hotels-rayoung-pattaya', newSlug:'top5-u-tapao-airport-hotels-chonburi', title:'5 ที่พักใกล้สนามบินอู่ตะเภา ชลบุรี', n:5 },
  { id:3593, old:'top-5-burapha-university-hotels-chonbulee', newSlug:'top5-burapha-university-hotels-chonburi', title:'5 ที่พักใกล้มหาวิทยาลัยบูรพา บางแสน ชลบุรี', n:5 },
];
...
สำคัญ: โรงแรมเดียวกันต้องได้ reviewSlug **เดียวกันเป๊ะ** ทุกที่ที่อ้างถึง`,
  { label:'plan:chonburi-c', phase:'Plan', schema:PLAN_SCHEMA })
