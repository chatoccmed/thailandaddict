export const meta = {
  name: 'port-khon-kaen',
  description: 'Single-planner porter for ขอนแก่น (cluster=khon-kaen): one agent plans all 2 roundup(s) together -> unique hotels -> reviews >=2000w -> roundups. Reuses existing khon-kaen reviews.',
  phases: [
...
const CLUSTER = "khon-kaen", PROV = "ขอนแก่น", CRUMB = "ขอนแก่น", CRUMBHREF = "city-khon-kaen.html";
const POSTS = [{"old":"top-ten-hotels-khon-kaen","newSlug":"top10-khon-kaen-popular-hotels","title":"10 โรงแรมยอดนิยมในเมืองขอนแก่น","n":10},{"old":"top10-khon-kaen-hotels-price-under-1000-bath","newSlug":"top10-khon-kaen-budget-hotels","title":"10 ที่พักหลักร้อยเดินทางสะดวกในขอนแก่น","n":10}];
...
const PLAN_SCHEMA = {"type":"object","additionalProperties":false,"required":["hotels","roundups"],"properties":{"hotels":{"type":"array","description":"โรงแรม unique ทั้งหมด (1 slug ต่อ 1 โรงแรมจริง ใช้ซ้ำข้าม roundup ได้)","items":{"type":"object","additionalProperties":false,"required":["name","reviewSlug","area","tier","star","open"],"properties":{"name":{"type":"string"},"reviewSlug":{"type":"string","description":"review-<hotel-kebab-en>-khon-kaen"},"area":{"type":"string"},"tier":{"type":"string"},"star":{"type":"number"},"open":{"type":"boolean"},"note":{"type":"string"}}}},"roundups":{"type":"array","description":"membership ต่อ roundup","items":{"type":"object","additionalProperties":false,"required":["newSlug","reviewSlugs"],"properties":{"newSlug":{"type":"string"},"reviewSlugs":{"type":"array","items":{"type":"string"},"description":"reviewSlug เรียงตามอันดับ"}}}}}};
