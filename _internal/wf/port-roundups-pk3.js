...
// === PK-3 (cluster=prachuap-khiri-khan): huay-yang x2, bang-saphan, bang-saphan-noi ===
const PROV = 'ประจวบคีรีขันธ์', CLUSTER = 'prachuap-khiri-khan', CRUMB = 'ประจวบคีรีขันธ์', CRUMBHREF = 'city-prachuap-khiri-khan.html';
const POSTS = [
  { id:3893, old:'top5-hotels-huay-yang-prachuap-khiri-khan', newSlug:'top5-huay-yang-beach-hotels-prachuap-khiri-khan', title:'5 ที่พักริมหาดห้วยยาง ประจวบคีรีขันธ์', n:5 },
  { id:1453, old:'top5-huay-yang-beach-prachuap-khiri-khan', newSlug:'top5-huay-yang-thap-sakae-hotels-prachuap-khiri-khan', title:'5 ที่พักเด็ดริมหาดห้วยยาง ทับสะแก ประจวบคีรีขันธ์', n:5 },
  { id:1979, old:'top6-bang-saphan-prachuap-khiri-khan-hotels', newSlug:'top6-bang-saphan-hotels-prachuap-khiri-khan', title:'6 ที่พักบรรยากาศดี ย่านบางสะพาน ประจวบคีรีขันธ์', n:6 },
  { id:1989, old:'top3-bang-saphan-noi-prachuap-khiri-khan-hotels', newSlug:'top3-bang-saphan-noi-hotels-prachuap-khiri-khan', title:'3 ที่พักบรรยากาศดี ย่านบางสะพานน้อย ประจวบคีรีขันธ์', n:3 },
];
...
สำคัญ: โรงแรมเดียวกันต้องได้ reviewSlug **เดียวกันเป๊ะ** ทุกที่ที่อ้างถึง`,
  { label:'plan:pk3', phase:'Plan', schema:PLAN_SCHEMA })
