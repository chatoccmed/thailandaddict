export const meta = {
  name: 'port-buriram',
  description: 'Single-planner porter for บุรีรัมย์ (cluster=buriram): one agent plans all 2 roundup(s) together -> unique hotels -> reviews >=2000w -> roundups. Reuses existing buriram reviews.',
  phases: [
...
const CLUSTER = "buriram", PROV = "บุรีรัมย์", CRUMB = "บุรีรัมย์", CRUMBHREF = "city-buriram.html";
const POSTS = [{"old":"top10-buriram-hotels","newSlug":"top10-buriram-popular-hotels","title":"10 ที่พักยอดนิยมในบุรีรัมย์ ใกล้สนามช้างอารีน่า","n":10},{"old":"top10-burirum-cheap-budget-hotels","newSlug":"top10-buriram-budget-hotels","title":"10 ที่พักหลักร้อยเมืองปราสาทหิน บุรีรัมย์","n":10}];
...
const PLAN_SCHEMA = {"type":"object","additionalProperties":false,"required":["hotels","roundups"],"properties":{"hotels":{"type":"array","description":"โรงแรม unique ทั้งหมด (1 slug ต่อ 1 โรงแรมจริง ใช้ซ้ำข้าม roundup ได้)","items":{"type":"object","additionalProperties":false,"required":["name","reviewSlug","area","tier","star","open"],"properties":{"name":{"type":"string"},"reviewSlug":{"type":"string","description":"review-<hotel-kebab-en>-buriram"},"area":{"type":"string"},"tier":{"type":"string"},"star":{"type":"number"},"open":{"type":"boolean"},"note":{"type":"string"}}}},"roundups":{"type":"array","description":"membership ต่อ roundup","items":{"type":"object","additionalProperties":false,"required":["newSlug","reviewSlugs"],"properties":{"newSlug":{"type":"string"},"reviewSlugs":{"type":"array","items":{"type":"string"},"description":"reviewSlug เรียงตามอันดับ"}}}}}};
