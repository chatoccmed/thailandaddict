...
// === PK-2 (cluster=prachuap-khiri-khan): prachuap-city x2, khlong-wan, pranburi, sam-roi-yot ===
const PROV = 'ประจวบคีรีขันธ์', CLUSTER = 'prachuap-khiri-khan', CRUMB = 'ประจวบคีรีขันธ์', CRUMBHREF = 'city-prachuap-khiri-khan.html';
const POSTS = [
  { id:3889, old:'top10-hotels-prachuap-khiri-khan', newSlug:'top9-prachuap-city-hotels', title:'9 ที่พักยอดนิยมในอำเภอเมืองประจวบคีรีขันธ์', n:9 },
  { id:837, old:'top10-prachuap-khiri-khan-hotel', newSlug:'top10-prachuap-city-scenic-hotels', title:'10 ที่พักบรรยากาศดีในเมืองประจวบคีรีขันธ์', n:10 },
  { id:1282, old:'top5-khlong-wan-prachuap-khiri-khan-hotels', newSlug:'top5-khlong-wan-beach-hotels-prachuap-khiri-khan', title:'5 ที่พักริมหาดคลองวาฬ ประจวบคีรีขันธ์', n:5 },
  { id:3887, old:'top4-resort-prachuap-khiri-khan', newSlug:'top4-pranburi-resorts-prachuap-khiri-khan', title:'4 รีสอร์ตสไตล์เก๋ในปราณบุรี ประจวบคีรีขันธ์', n:4 },
  { id:1980, old:'top10-hotels-sam-roi-yot-prachuap-khiri-khan', newSlug:'top10-sam-roi-yot-hotels-prachuap-khiri-khan', title:'10 ที่พักบรรยากาศสวยในสามร้อยยอด ประจวบคีรีขันธ์', n:10 },
];
...
const PLAN_SCHEMA={type:'object',additionalProperties:false,required:['hotels','roundups'],properties:{
  hotels:{type:'array',description:'โรงแรม unique ทั้งหมด (1 slug ต่อ 1 โรงแรมจริง ใช้ซ้ำข้าม roundup ได้)',items:{type:'object',additionalProperties:false,required:['name','reviewSlug','area','tier','star','open'],properties:{
    name:{type:'string'},reviewSlug:{type:'string',description:'review-<hotel-kebab>-prachuap-khiri-khan'},area:{type:'string'},tier:{type:'string'},star:{type:'number'},open:{type:'boolean'},note:{type:'string'}}}},
...
สำคัญ: โรงแรมเดียวกันต้องได้ reviewSlug **เดียวกันเป๊ะ** ทุกที่ที่อ้างถึง`,
  { label:'plan:pk2', phase:'Plan', schema:PLAN_SCHEMA })
...
- รูป hero: curl -m 60 -A "Mozilla/5.0" รูปจริง → astro/public/images/hotels/prachuap-<short>.jpg (hero+gallery 3) แล้ว node _internal/optimize-images.mjs <paths>; ไม่ได้ปล่อย path (onerror)
${STYLE}
