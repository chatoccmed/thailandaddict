export const meta = {
  name: 'lanta-photo-sourcing',
  description: 'Find 4 directly-downloadable real photos per Koh Lanta hotel (hero + 3 gallery) from official sites / Trip.com',
  phases: [{ title: 'Sources' }],
}
const RESEARCH = 'C:\\Users\\Imac\\Thailandaddict\\thailandaddict\\_internal\\wf\\lanta\\research.json'
const SCHEMA = {
...
const results = await parallel(SLUGS.map(slug => () =>
  agent(
    `Find up to 4 directly-downloadable REAL photos of a specific Koh Lanta hotel, for a Thai travel-site review.
