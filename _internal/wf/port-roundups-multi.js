...
// === central Pattaya chunk (cluster=pattaya) — 5 heavily-overlapping lists ===
const PROV = 'ชลบุรี', CLUSTER = 'pattaya', CRUMB = 'พัทยา', CRUMBHREF = 'city-pattaya.html';
const POSTS = [
  { id:4101, old:'top-10-pattaya-chonburi', newSlug:'top10-luxury-hotels-pattaya', title:'10 ที่พักสุดหรูในพัทยา ชลบุรี', n:10 },
  { id:3045, old:'top-10-chonburi-province-hotel', newSlug:'top10-pattaya-beachfront-resorts', title:'10 รีสอร์ตหรูริมหาดพัทยา ชลบุรี', n:10 },
  { id:3033, old:'top10-hotels-pattaya', newSlug:'top10-budget-hotels-pattaya', title:'10 ที่พักหลักร้อยงบน้อยในพัทยา', n:10 },
  { id:787, old:'top10-pattaya-hotel', newSlug:'top10-beach-hotels-pattaya', title:'10 ที่พักใกล้ชายหาดพัทยา', n:10 },
  { id:3047, old:'top10-hotels-walking-street-pattaya', newSlug:'top10-walking-street-hotels-pattaya', title:'10 ที่พักใกล้ Walking Street พัทยา', n:10 },
];
...
สำคัญ: โรงแรมเดียวกันต้องได้ reviewSlug **เดียวกันเป๊ะ** ทุกที่ที่อ้างถึง`,
  { label:'plan:pattaya-central', phase:'Plan', schema:PLAN_SCHEMA })
