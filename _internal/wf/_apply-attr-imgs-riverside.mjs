import fs from 'fs';
const B = '/images/food/riverside/';
const HERO = { file: 'riverside-hero.jpg', th: 'ภาพ: พระปรางค์วัดอรุณริมแม่น้ำเจ้าพระยา (มองจากเรือข้ามฟาก) · Diliff / Wikimedia (CC BY-SA 3.0)', en: 'Photo: Wat Arun prang on the Chao Phraya River (from the ferry) · Diliff / Wikimedia (CC BY-SA 3.0)', href: 'https://commons.wikimedia.org/wiki/File:Wat_Arun_from_Chao_Phraya_River.jpg' };
const IMG = {};
for (const [path, isEn] of [['astro/src/content/articles/top10-attractions-riverside.json', false], ['astro/src/content/articles-en/top10-attractions-riverside.json', true]]) {
