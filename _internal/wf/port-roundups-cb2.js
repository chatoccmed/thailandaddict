export const meta = {
  name: 'port-roundups-cb2',
  description: 'Chonburi chunk 2 — Sriracha (onsen+15+budget5) + Amata (Nakorn, City) roundups + per-hotel reviews >=2000w TH',
  phases: [
...
const POSTS = [
  { id:4342, old:'top7-japan-hotel-onsen-sriracha-chonburi', newSlug:'top7-onsen-hotels-sriracha-chonburi', cluster:'chonburi', area:'ศรีราชา', title:'7 ที่พักพร้อมออนเซ็นสไตล์ญี่ปุ่น ศรีราชา ชลบุรี' },
  { id:3021, old:'top15-hotels-chonburi-sriracha', newSlug:'top15-hotels-sriracha-chonburi', cluster:'chonburi', area:'ศรีราชา', title:'15 ที่พักยอดนิยมในศรีราชา ชลบุรี' },
  { id:3023, old:'top5-hotel-sriracha-chon-buri', newSlug:'top5-budget-hotels-sriracha-chonburi', cluster:'chonburi', area:'ศรีราชา', title:'5 ที่พักหลักร้อยในศรีราชา ชลบุรี' },
  { id:3719, old:'top-5-amata-nakorn-chonburi', newSlug:'top5-amata-nakorn-hotels-chonburi', cluster:'chonburi', area:'อมตะนคร', title:'5 ที่พักใกล้นิคมอมตะนคร ชลบุรี' },
  { id:2991, old:'top10-amata-city-industrial-park-chanburi', newSlug:'top10-amata-city-hotels-chonburi', cluster:'chonburi', area:'อมตะซิตี้', title:'10 ที่พักใกล้นิคมอมตะซิตี้ ชลบุรี' },
];
