export const meta = {
  name: 'port-ratchaburi',
  description: 'Single-planner porter for ราชบุรี (cluster=ratchaburi): one agent plans all 3 roundup(s) together -> unique hotels -> reviews >=2000w -> roundups. Reuses existing ratchaburi reviews.',
  phases: [
...
const CLUSTER = "ratchaburi", PROV = "ราชบุรี", CRUMB = "ราชบุรี", CRUMBHREF = "city-ratchaburi.html";
const POSTS = [{"old":"top10-ratchaburi-hotels","newSlug":"top10-ratchaburi-city-hotels","title":"10 ที่พักบรรยากาศดีในเมืองราชบุรี","n":10},{"old":"top15-suan-phung-ratchaburi-hotel","newSlug":"top15-suan-phung-hotels-ratchaburi","title":"15 ที่พักโรแมนติกที่สวนผึ้ง ราชบุรี","n":15},{"old":"top-5-hotel-ratchaburi","newSlug":"top5-suan-phung-budget-hotels-ratchaburi","title":"5 ที่พักหลักร้อยในสวนผึ้ง ราชบุรี","n":5}];
...
const PLAN_SCHEMA = {"type":"object","additionalProperties":false,"required":["hotels","roundups"],"properties":{"hotels":{"type":"array","description":"โรงแรม unique ทั้งหมด (1 slug ต่อ 1 โรงแรมจริง ใช้ซ้ำข้าม roundup ได้)","items":{"type":"object","additionalProperties":false,"required":["name","reviewSlug","area","tier","star","open"],"properties":{"name":{"type":"string"},"reviewSlug":{"type":"string","description":"review-<hotel-kebab-en>-ratchaburi"},"area":{"type":"string"},"tier":{"type":"string"},"star":{"type":"number"},"open":{"type":"boolean"},"note":{"type":"string"}}}},"roundups":{"type":"array","description":"membership ต่อ roundup","items":{"type":"object","additionalProperties":false,"required":["newSlug","reviewSlugs"],"properties":{"newSlug":{"type":"string"},"reviewSlugs":{"type":"array","items":{"type":"string"},"description":"reviewSlug เรียงตามอันดับ"}}}}}};
