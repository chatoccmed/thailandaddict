...
### 🟢 Lat Phrao (ลาดพร้าว) — BUILDING NOW · North/NE BKK (Lat Phrao Rd corridor · โชคชัย 4 · MRT Lat Phrao/Phahon Yothin · Union Mall) — ⚠️ Centara Grand at Central Plaza Ladprao already used as mochit reuse; differentiate. **🔀 central-ladprao FOLDED INTO ladprao — skip** (Ha Yaek/Central Plaza node ≈100% overlap with the built mochit-chatuchak ย่าน + this ladprao). Reuse seeds: review-livotel-lat-phrao, review-synsiri-ladprao-130 + where-to-stay-bangkok-ladprao.
