...
### (loop B next) Bang Sue (บางซื่อ) — NEXT · North BKK (Bang Sue Grand Station/สถานีกลางกรุงเทพอภิวัฒน์ · MRT Bang Sue/Tao Poon · Chatuchak-adjacent NW). ⚠️ differentiate attractions from mochit (JJ/Or Tor Kor/Chatuchak Park = mochit's). Then: bang-khen · kaset · chaeng-watthana · ramkhamhaeng · bangkapi · charoen-krung (⚠️vs riverside/silom) · saphan-taksin (⚠️vs riverside/silom).
