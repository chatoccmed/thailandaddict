...
- **[2026-06-27 · Bangkok ย่าน megaproject — มี 2 loop วิ่งพร้อมกัน]**
    - **loop A (central core):** ✅ #8 siam-pratunam + ✅ #9 chidlom + ✅ #10 ratchathewi DONE+LIVE → NOW จับ **#11 rama9** (พระราม 9-รัชดา-ห้วยขวาง · Central Rama 9/Fortune/Swissôtel Ratchada/RCA · reuse avani-ratchada/cassia-rama-9/maitria-rama-9/somerset-rama-9/calmly-stay-ratchada + ~5 new). ploenchit→chidlom, victory-monument→ratchathewi (folded/skip). ถัดไป ratchada/charoen-krung/saphan-taksin/ramkhamhaeng/bangkapi/pinklao/talat-phlu/bang-sue/bang-khen/kaset/chaeng-watthana/sai-tai (เลี่ยง riverside+phrom+on-nut+mochit/bangna/srinakarin/ladprao = loop B)
