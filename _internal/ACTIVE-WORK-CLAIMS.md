...
## 🟢 ACTIVE
- **[2026-08-27 → 2026-08-31 · Claude session · thailandaddict repo] ✅ DONE — “ลงตัว” cliché rewrite across TH hotel reviews.** ขอบเขตที่ claim ไว้ = 294 ไฟล์ / 448 จุด ที่ใช้คำนี้เป็น filler ปิดประโยค · ผลจริง **แก้แล้ว 291 ไฟล์ / 442 จุด** เขียนใหม่ให้อ้างรายละเอียดเฉพาะของโรงแรมนั้นจากเนื้อหาในไฟล์เดิม (ไม่แต่งเพิ่ม, string-replacement ล้วน ไม่ reformat JSON) · ตรวจแล้ว JSON valid 291/291 · regen hub ที่ฝัง excerpt ของรีวิว 86 ไฟล์ (64 city + 19 activities + sitemap/search-index/near-me-index) · **ปลดล็อกแล้ว — `astro/src/content/reviews/*.json` แตะได้ตามปกติ** · เหลือ “ลงตัว” นอกขอบเขตนี้อีก **353 ไฟล์ / 540 จุด** (ส่วนใหญ่ใช้เป็นคำปกติ ไม่ใช่ filler) ยังไม่มีใคร claim
