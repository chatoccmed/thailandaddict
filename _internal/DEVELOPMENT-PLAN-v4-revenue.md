...
| Decision-content ("vs"/"worth it"/"best time") | vs=18-19 ไฟล์, worth-it=0 หน้าเฉพาะ, best-time=1 หน้ารวมทั้งประเทศ | อยุธยา (top-10 destination) **ไม่มี vs-content เลย** |
